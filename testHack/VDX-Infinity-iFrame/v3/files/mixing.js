		...
		return this.each(function(){
			...
			$That.draggable({
				...
				drag:function(event, ui){					
                    ...
                    //$(settings.dragContainer + " li:last").margin-left(485+(485 - elemPos));
                    $(settings.dragContainer + " .fiftyBanner iframe").width(485+(485 - elemPos));
                    document.getElementById("videoContainerName").width= elemPos
                    //console.log(document.getElementsByName("imgContainerName").width);
                   // document.getElementById("test2").width= 485+(485 - elemPos);
