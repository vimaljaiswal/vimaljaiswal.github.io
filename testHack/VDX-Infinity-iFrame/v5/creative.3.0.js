        ...
        var n = t.utility
            , s = t.ObserverClass.extend({
                ...
                , bindRender: function () {
				 ...
				 // window.showTeaser  =this.handleVideoFullScreen.bind(this);
				// window.showMain  =this.helper.transitions.teaser2VPM.call(this.helper).bind(this);
               // top = 
                ...
                , mainunitCloseCB: function () {
					//console.log(window.parent.parent.parent.mainUnitClosed());
					window.parent.parent.parent.mainUnitClosed();
