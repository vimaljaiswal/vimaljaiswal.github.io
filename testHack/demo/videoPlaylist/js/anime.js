 ...
 *
 * Maaiz - made changes to append the already existing transforms
 */
...
(function (root, factory) {
  ...
  var removeAllWillChange = function(allAnimations) {
    for (var i = 0 ; i < allAnimations.length; i++) {
      removeWillChange(allAnimations[i]);
    }
  }
  ...
  var setAnimationProgress = function(anim, time) {
    ...
    if (transforms) {
      ...
      for (var t in transforms) {
        ...
        anim.animatables[t].target.style[transform] += anim.settings.initialTransform;
  ...
  var animation = function(params) {
    ...
    anim.killAnimation = function() {
      // removeWillChange(animat
      // ions);
      animations[0].settings.complete;
      animations = [];
    }
