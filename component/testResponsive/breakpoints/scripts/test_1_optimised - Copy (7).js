(function () {
    ...
    function onWindowResized() {
        ...
        var resizedTimer = setTimeout(function () {
            ...
            // console.log(countOrientation + "  >>>>>>>>>IFFF>>>>>>>>>")
            if (countOrientation < 2) {
                // alert(countOrientation+ "  >>>>>>>>>IFFF>>>>>>>>>");
                // console.log(countOrientation + "  >>>>>>>>>IFFF>>>>>>>>>")

                //removeInitails([parentDivStack, lightBoxDivStack]);

            } else {
                //  alert(countOrientation+ "  >>>>>>>>>ELSE>>>>>>>>>");
                //  console.log(countOrientation + "  >>>>>>>ELSE>>>>>>>>>>>")
...
/*
close,right button position on landscape mode ios and android orientation chnage issue
sometimes images stuck and two images are shown at a time orientation chnage issue
*/