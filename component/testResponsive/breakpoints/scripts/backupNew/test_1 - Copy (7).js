            ...
            for (var i = 0; i < parentDivStack[k].length; i++) {
                ...
                for (var j = 0; j < subDiv.length; j++) {
                    ...
                    if (subDiv[j].getAttribute('class') != "clearfix grpelem shared_content") {
                        if (subDiv[j].getAttribute('class') != "museBGSize colelem shared_content") {
                            if (subDiv[j].getAttribute('class') != "museBGSize clearfix colelem shared_content") {
                                if (subDiv[j].getAttribute('class') != "colelem shared_content") {
