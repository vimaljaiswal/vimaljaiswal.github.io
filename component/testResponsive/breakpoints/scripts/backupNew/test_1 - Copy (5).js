(function () {
    ...
    window.addEventListener("orientationchange", function () {
        console.log(DupliAllowedBreakPoints.length + "    DupliAllowedBreakPoints");
        if (DupliAllowedBreakPoints.length <= 1) {
                        ...
                        if (childDivs[j].getAttribute('class') != "clearfix grpelem shared_content") {
                            ...
                            if (childInitialWidth != undefined) {
                                if (childInitialWidth.slice(-1) === "%") {
                                    var newWidth = ((childInitialWidth * totalRatioWidth));
            ...
            for (var i = 0; i < parentDivStack[k].length; i++) {
                ...
                for (var j = 0; j < subDiv.length; j++) {
                    ...
                    if (subDiv[j].getAttribute('class') != "clearfix grpelem shared_content") {
                        ...
                        if (DupliAllowedBreakPoints.length < 2) {
...
/*
1: from landscape start then move to potrait.
2: from potrait to landscape, then 1st frame.
*/