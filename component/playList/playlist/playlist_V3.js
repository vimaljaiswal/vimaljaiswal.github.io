var vdxResponsivePlaylistWidget = (function () {
    ...
    function backwardCompatibility() {
        if (document.querySelectorAll("div[title='vdxContainer_vPlayListThumb_show']").length > 0) {
            ...
            root.playListThumbSelectionBack = ')';
            root.vPlayListThumb_show = "div.vdxContainer_vPlayListThumb_hide";
            ...
            //document.querySelector("div.breakpoint.active div.vdxContainer_vPlayListThumb"+i)

            //tempThumb.querySelector("div.vdxContainer_vPlayListThumb_hide").style.opacity = "1";

            //tempThumb.querySelector("div.vdxContainer_vPlayListThumb_show").style.opacity = "0";

            //document.querySelector("div.breakpoint.active div.vdxContainer_vPlayListStack"+Math.ceil(num/3)+"Trigger");
    ...
    function selectStack() {
        ...
        var stack = document.querySelector(eval(root.vPlayListStack + Math.ceil(num / 3) + root.vPlayListStackBack));
