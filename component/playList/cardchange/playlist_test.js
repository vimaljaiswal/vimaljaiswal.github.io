...
var vdxScrollEventHandlerWidget = (function () {
    ...
    function onCardChange(obj) {
        ...
        for (var propertyName in obj) {
            if (obj[0].inViewPercent != 100) {
                if (obj[0].inViewPercent > obj[1].inViewPercent) {
                    cardInView = {
                        selectedCard: obj[0].name,
                        viewPercent: obj[0].inViewPercent
                    };
                } else {
                    cardInView = {
                        selectedCard: obj[1].name,
                        viewPercent: obj[1].inViewPercent
                    };
                }
            } else {
                cardInView = {
