...
//		_this._screenRect			= screenRect		|| new lib.Rectangle(   0,   0,  640, 480),	// Shown video screen rectangle
		...
		_this._cameraResolution		= cameraResolution	|| new lib.Rectangle(   0,   0,  970, 470),	// Camera resolution
		_this._brfResolution		= brfResolution		|| new lib.Rectangle(   0,   0,  970, 470),	// BRF BitmapData size
...
//		_this._screenRect			= screenRect		|| new lib.Rectangle(   0,   0, 1280, 720),	// Shown video screen rectangle
		...
		_this.initGUI = function() {
			...
			if (window['Stats'] !== undefined) {
				...
				_this._stats.domElement.style.left = (_this._screenRect.x + _this._screenRect.width) + 'px';
